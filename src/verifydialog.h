...
#include "verifydialogbase.h"

class VerifyDialog : public VerifyDialogBase
{
    Q_OBJECT

public:
    VerifyDialog( QString msg, QWidget* parent = 0, const char* name = 0, bool modal = FALSE, WFlags fl = 0 );
